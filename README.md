...
Elemental World is a 3D action RPG built in Unity, featuring a multi-phase boss system, dynamic combat mechanics, and a structured world progression loop.
...
- State-driven AI using phase system
- Coroutine-based attack sequencing
...
- Clean separation of systems:
  ...
  - UI
  - Scene Management
- Scalable architecture for future bosses and abilities
